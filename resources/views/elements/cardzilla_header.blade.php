        ...
        <div class="container">
            ...
            <div class="ms-3 text-nowrap"><a class="topbar-link me-4 d-none d-md-inline-block"
                ...
                <div class="topbar-text dropdown disable-autohide"><a class="topbar-link dropdown-toggle" href="#"
                        data-bs-toggle="dropdown"><img class="me-2" src="{{url('assets/img/flags/en.png')}}" width="20" alt="English">Eng / $</a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="{{url('assets/img/flags/fr.png')}}" width="20"
                                    alt="Français">Français</a></li>
                        <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="{{url('assets/img/flags/de.png')}}" width="20"
                                    alt="Deutsch">Deutsch</a></li>
                        <li><a class="dropdown-item" href="#"><img class="me-2" src="{{url('assets/img/flags/it.png')}}" width="20"
        ...
        <div class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand d-none d-sm-block flex-shrink-0" href="{{url('')}}">
                    <img src="{{url('assets/img/logo-dark.png')}}" width="142" alt="Cartzilla">
                </a>
                <a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="{{url('')}}">
                    <img src="{{url('assets/img/logo-icon.png')}}" width="74" alt="Cartzilla">
                </a>
                            ...
                            <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                                <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                                    <div class="widget-cart-item pb-2 border-bottom">
                                        ...
                                        <div class="d-flex align-items-center"><a class="flex-shrink-0"
                                                href="shop-single-v1.html"><img src="{{url('assets/img/shop/cart/widget/01.jpg')}}"
                                    ...
                                    <div class="widget-cart-item py-2 border-bottom">
                                        <button class="btn-close text-danger" type="button" aria-label="Remove"><span
                                                aria-hidden="true">&times;</span></button>
                                        <div class="d-flex align-items-center"><a class="flex-shrink-0"
                                                href="shop-single-v1.html"><img src="{{url('assets/img/shop/cart/widget/02.jpg')}}"
                                                    width="64" alt="Product"></a>
                                            <div class="ps-2">
                                                <h6 class="widget-product-title"><a href="shop-single-v1.html">TH Jeans
                                                        City Backpack</a></h6>
                                                <div class="widget-product-meta"><span
                                    ...
                                    <div class="widget-cart-item py-2 border-bottom">
                                        <button class="btn-close text-danger" type="button" aria-label="Remove"><span
                                                aria-hidden="true">&times;</span></button>
                                        <div class="d-flex align-items-center"><a class="flex-shrink-0"
                                                href="shop-single-v1.html"><img src="{{url('assets/img/shop/cart/widget/03.jpg')}}"
                                                    width="64" alt="Product"></a>
                                            <div class="ps-2">
                                                <h6 class="widget-product-title"><a href="shop-single-v1.html">3-Color
                                                        Sun Stash Hat</a></h6>
                                                <div class="widget-product-meta"><span
                                    ...
                                    <div class="widget-cart-item py-2 border-bottom">
                                        <button class="btn-close text-danger" type="button" aria-label="Remove"><span
                                                aria-hidden="true">&times;</span></button>
                                        <div class="d-flex align-items-center"><a class="flex-shrink-0"
                                                href="shop-single-v1.html"><img src="{{url('assets/img/shop/cart/widget/04.jpg')}}"
                                                    width="64" alt="Product"></a>
                                            <div class="ps-2">
                                                <h6 class="widget-product-title"><a href="shop-single-v1.html">Cotton
                                                        Polo Regular Fit</a></h6>
                                                <div class="widget-product-meta"><span
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                    <div class="fs-sm me-2 py-2"><span class="text-muted">Subtotal:</span><span
                                            class="text-accent fs-base ms-1">$265.<small>00</small></span></div><a
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav navbar-mega-nav pe-lg-2 me-lg-2">
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle ps-lg-0" href="#"
                                data-bs-toggle="dropdown"><i class="ci-view-grid me-2"></i>Categories</a>
                            <div class="dropdown-menu px-2 pb-4">
                                <div class="d-flex flex-wrap flex-sm-nowrap">
                                    <div class="mega-dropdown-column pt-3 pt-sm-4 px-2 px-lg-3">
                                        <div class="widget widget-links"><a
                                                class="d-block overflow-hidden rounded-3 mb-3" href="#"><img
                                                    src="{{url('assets/img/shop/departments/01.jpg')}}" alt="Clothing"></a>
                                    ...
                                    <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                                        <div class="widget widget-links"><a
                                                class="d-block overflow-hidden rounded-3 mb-3" href="#"><img
                                                    src="{{url('assets/img/shop/departments/02.jpg')}}" alt="Shoes"></a>
                                    ...
                                    <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                                        <div class="widget widget-links"><a
                                                class="d-block overflow-hidden rounded-3 mb-3" href="#"><img
                                                    src="{{url('assets/img/shop/departments/03.jpg')}}" alt="Gadgets"></a>
                                ...
                                <div class="d-flex flex-wrap flex-sm-nowrap">
                                    <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                                        <div class="widget widget-links"><a
                                                class="d-block overflow-hidden rounded-3 mb-3" href="#"><img
                                                    src="{{url('assets/img/shop/departments/04.jpg')}}" alt="Furniture"></a>
                                    ...
                                    <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                                        <div class="widget widget-links"><a
                                                class="d-block overflow-hidden rounded-3 mb-3" href="#"><img
                                                    src="{{url('assets/img/shop/departments/05.jpg')}}" alt="Accessories"></a>
                                    ...
                                    <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                                        <div class="widget widget-links"><a
                                                class="d-block overflow-hidden rounded-3 mb-3" href="#"><img
                                                    src="{{url('assets/img/shop/departments/06.jpg')}}" alt="Entertainment"></a>
                    ...
                    <!-- Primary menu-->
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown @if(isset($active_menu) && $active_menu == 'home') active @endif"><a class="nav-link dropdown-toggle" href="#"
                                ...
                                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom"
                                    ...
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            href="home-fashion-store-v1.html" style="width: 250px;"><img
                                                src="{{url('assets/img/home/preview/th01.jpg')}}" alt="Fashion Store v.1"></a></div>
                                </li>
                                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom"
                                    ...
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            href="home-electronics-store.html" style="width: 250px;"><img
                                                src="{{url('assets/img/home/preview/th03.jpg')}}" alt="Electronics Store"></a></div>
                                </li>
                                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom"
                                    ...
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            href="home-marketplace.html" style="width: 250px;"><img
                                                src="{{url('assets/img/home/preview/th04.jpg')}}" alt="Marketplace"></a></div>
                                </li>
                                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom"
                                    ...
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            href="home-grocery-store.html" style="width: 250px;"><img
                                                src="{{url('assets/img/home/preview/th06.jpg')}}" alt="Grocery Store"></a></div>
                                </li>
                                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom"
                                    ...
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            href="home-food-delivery.html" style="width: 250px;"><img
                                                src="{{url('assets/img/home/preview/th07.jpg')}}" alt="Food Delivery Service"></a></div>
                                </li>
                                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom"
                                    ...
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            href="home-fashion-store-v2.html" style="width: 250px;"><img
                                                src="{{url('assets/img/home/preview/th02.jpg')}}" alt="Fashion Store v.2"></a></div>
                                </li>
                                <li class="dropdown position-static mb-0"><a class="dropdown-item py-2"
                                    ...
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            href="home-single-store.html" style="width: 250px;"><img
                                                src="{{url('assets/img/home/preview/th05.jpg')}}" alt="Single Product / Brand Store"></a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown @if(isset($active_menu) && $active_menu == 'shop') active @endif"><a class="nav-link dropdown-toggle" href="#"
                        ...
                        <li class="nav-item @if(isset($active_menu) && $active_menu == 'about') active @endif">
                            <a href="{{url('about-us')}}" class="nav-link">About us</a>
                        </li>
                        <li class="nav-item @if(isset($active_menu) && $active_menu == 'contact') active @endif">
                            <a href="{{url('contact-us')}}" class="nav-link">Contact us</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('error-404')}}" class="nav-link">Feedback</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('error-505')}}" class="nav-link">Help</a>
                        </li>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#">Blog Grid
                                        Layouts</a>
                                    <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="docs/changelog.html">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2"><span class="d-block text-heading">Changelog<span
                                                        class="badge bg-success ms-2">v2.0</span></span><small
