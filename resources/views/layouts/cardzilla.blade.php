...
<head>
    <meta charset="utf-8">
    <title>My Ustore | Fashion Store v.1</title>
    <!-- SEO Meta Tags-->
    <meta name="description" content="My Ustore - Bootstrap E-commerce Template">
    <meta name="keywords"
        content="bootstrap, shop, e-commerce, market, modern, responsive,  business, mobile, bootstrap, html5, css3, js, gallery, slider, touch, creative, clean">
    <meta name="author" content="My Ustore">
    <!-- Viewport-->
    ...
    <link rel="stylesheet" href="{{url('assets/vendor/tiny-slider/dist/tiny-slider.css')}}" />
    <link rel="stylesheet" href="{{url('assets/vendor/drift-zoom/dist/drift-basic.min.css')}}" />
...
<body class="handheld-toolbar-enabled">
                            ...
                            <div class="product-gallery">
                                <div class="product-gallery-preview order-sm-2">
                                    <div class="product-gallery-preview-item active" id="first"><img class="image-zoom"
                                            src="{{url('assets/img/shop/single/gallery/01.jpg')}}"
                                            data-zoom="{{url('assets/img/shop/single/gallery/01.jpg')}}" alt="Product image">
                                        <div class="image-zoom-pane"></div>
                                    </div>
                                    <div class="product-gallery-preview-item" id="second"><img class="image-zoom"
                                            src="{{url('assets/img/shop/single/gallery/02.jpg')}}"
                                            data-zoom="{{url('assets/img/shop/single/gallery/02.jpg')}}" alt="Product image">
                                        <div class="image-zoom-pane"></div>
                                    </div>
                                    <div class="product-gallery-preview-item" id="third"><img class="image-zoom"
                                            src="{{url('assets/img/shop/single/gallery/03.jpg')}}"
                                            data-zoom="{{url('assets/img/shop/single/gallery/03.jpg')}}" alt="Product image">
                                        <div class="image-zoom-pane"></div>
                                    </div>
                                    <div class="product-gallery-preview-item" id="fourth"><img class="image-zoom"
                                            src="{{url('asset/img/shop/single/gallery/04.jpg')}}"
                                            data-zoom="{{url('assets/img/shop/single/gallery/04.jpg')}}" alt="Product image">
                                        <div class="image-zoom-pane"></div>
                                    </div>
                                </div>
                                <div class="product-gallery-thumblist order-sm-1"><a
                                        class="product-gallery-thumblist-item active" href="#first"><img
                                            src="{{url('assets/img/shop/single/gallery/th01.jpg')}}" alt="Product thumb"></a><a
                                        class="product-gallery-thumblist-item" href="#second"><img
                                            src="{{url('assets/img/shop/single/gallery/th02.jpg')}}" alt="Product thumb"></a><a
                                        class="product-gallery-thumblist-item" href="#third"><img
                                            src="{{url('assets/img/shop/single/gallery/th03.jpg')}}" alt="Product thumb"></a><a
                                        class="product-gallery-thumblist-item" href="#fourth"><img
                                            src="{{url('assets/img/shop/single/gallery/th04.jpg')}}" alt="Product thumb"></a></div>
                            </div>
                        </div>
                        <!-- Product details-->
                                ...
                                <div class="position-relative me-n4 mb-3">
                                    <div class="form-check form-option form-check-inline mb-2">
                                        ...
                                        <label class="form-option-label rounded-circle" for="color1"><span
                                                ...
                                                style="background-image: url(assets/img/shop/single/color-opt-1.png)"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-2">
                                        ...
                                        <label class="form-option-label rounded-circle" for="color2"><span
                                                class="form-option-color rounded-circle"
                                                style="background-image: url(assets/img/shop/single/color-opt-2.png)"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-2">
                                        ...
                                        <label class="form-option-label rounded-circle" for="color3"><span
                                                class="form-option-color rounded-circle"
                                                style="background-image: url(assets/img/shop/single/color-opt-3.png)"></span></label>
                                    </div>
    ...
    <!-- include header -->
    @include('elements.cardzilla_header')

    <!-- inlcude content -->
    @yield('content')

    <!-- include footer -->
    @include('elements.cardzilla_footer')
    ...
    <script src="{{url('assets/vendor/tiny-slider/dist/min/tiny-slider.js')}}"></script>
    <script src="{{url('assets/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js')}}"></script>
    <script src="{{url('assets/vendor/drift-zoom/dist/Drift.min.js')}}"></script>
    <!-- Main theme script-->
