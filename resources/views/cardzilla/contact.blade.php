@extends('layouts.cardzilla',['active_menu' => 'contact'])
@section('content')
<!-- Page Title (Light)-->
                ...
                <div class="card-body text-center"><i class="ci-phone h3 mt-2 mb-4 text-primary"></i>
                    ...
                    <ul class="list-unstyled fs-sm mb-0">
                        ...
                        <li class="mb-0"><span class="text-muted me-1">Tech support:</span><a class="nav-link-style"
                                href="tel:+100331697720">+1 00 33 169 7720</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="container pt-4 mt-md-4 mb-5">
    ...
    <div class="row pt-4">
        <div class="col-md-4 col-sm-6 mb-grid-gutter">
            <div class="card border-0 shadow"><img class="card-img-top" src="{{url('assets/img/contacts/orlando.jpg')}}" alt="Orlando">
                <div class="card-body">
                    <h6>Orlando, USA</h6>
        ...
        <div class="col-md-4 col-sm-6 mb-grid-gutter">
            <div class="card border-0 shadow"><img class="card-img-top" src="{{url('assets/img/contacts/chicago.jpg')}}" alt="Chicago">
                <div class="card-body">
                    <h6>Chicago, USA</h6>
                    <ul class="list-unstyled mb-0">
                        <li class="d-flex pb-3 border-bottom"><i class="ci-location fs-lg mt-2 mb-0 text-primary"></i>
                            <div class="ps-3"><span class="fs-ms text-muted">Find us</span><a
                                    class="d-block text-heading fs-sm" href="#">769, Industrial, West Chicago, IL 60185,
                                    USA</a></div>
                        </li>
                        <li class="d-flex pt-2 pb-3 border-bottom"><i class="ci-phone fs-lg mt-2 mb-0 text-primary"></i>
                            <div class="ps-3"><span class="fs-ms text-muted">Call us</span><a
        ...
        <div class="col-md-4 col-sm-12 mb-grid-gutter">
            <div class="card border-0 shadow"><img class="card-img-top" src="{{url('assets/img/contacts/newyork.jpg')}}" alt="New York">
                <div class="card-body">
                    <h6>New York, USA</h6>
                    <ul class="list-unstyled mb-0">
                        <li class="d-flex pb-3 border-bottom"><i class="ci-location fs-lg mt-2 mb-0 text-primary"></i>
